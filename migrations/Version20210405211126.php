 ...
 */
final class Version20210405211126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD article INT NOT NULL, CHANGE client_id panier INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD client_id INT NOT NULL, DROP panier, DROP article');
